...
const getAbi = () => {
  try {
    const dir = path.resolve(
      __dirname,
      "../artifacts/contracts/Casino.sol/Casino.json"
    )
...
const contractAddr = '0x91e556a34bef0d6550015da377c07bf8fa1c8c96'
const abi = getAbi()
...
describe("Casino", async () => {
  ...
  it("Work all the way through (B wins)", async () => {
    ...
    f = await ethers.getContractFactory("Casino")
    cA = await f.attach(contractAddr);
